  ...
  return <div className="page generic-page">
    ...
    <div className="progress-hero">
      ...
      <div className="skill-list">
        <Evidence label="Vocabulary / recall" state={reviews?'измеряется':'нет данных'} detail={reviews?`${reviews} ответов · ${stats.active} элементов подтверждены в active use`:'пройди первую сессию'}/>
        ...
        <Evidence label="Speaking / writing" state={outputAttempts?`${outputAttempts} попыт. · ${outputMinutes} мин`:'нет данных'} detail="продуктивные задачи с возвратом через несколько дней"/>
    ...
    <div className="stats-grid wide-stats">
      ...
      <Metric title="Active use" value={String(stats.active)} hint="минимум два продуктивных употребления"/>
